...
int rightThumbC = rightThumb;
int rightIndexC = rightIndex;
int rightMiddleC = rightMiddle;
int rightRingC = rightRing;
int rightPinkyC = rightPinky;
...
//   rightPinky = 40;
//   alltovirtual(); // Example: alltovirtual
//   delay(250); // Wait 2500 milliseconds (.25 seconds) ???
// }
void signWithDelay(){
  servothumb.write(rightThumbO);
  delay(standardDelay);
...
void makeB(){
  //openHand();
  rightThumb = rightThumbC;
  rightIndex = rightIndexO;
  rightMiddle = rightMiddleO;
  rightRing = rightRingO;
  rightPinky = rightPinkyO;
  signWithDelay();
  //alltovirtual(); // Example: alltovirtual
  delay(4*standardDelay); // Wait 2500 milliseconds (.25 seconds) ???
}
void makeU(){
  rightThumb = rightThumbC;
  rightIndex = rightIndexO;
  rightMiddle = rightMiddleO;
  rightRing = rightRingC;
  rightPinky = rightPinkyC;
  signWithDelay();
  //alltovirtual(); // Example: alltovirtual
  delay(4*standardDelay); // Wait 2500 milliseconds (.25 seconds) ???
}
void makeD(){
  ...
  rightThumb = rightThumbC;
  rightIndex = rightIndexO;
  rightMiddle = rightMiddleC;
  rightRing = rightRingC;
  rightPinky = rightPinkyC;
  signWithDelay();
  //alltovirtual(); // Example: alltovirtual
  delay(4*standardDelay);
}
void makeY(){
  servothumb.write(rightThumbO);
  delay(standardDelay);
  rightThumb = rightThumbO;
  rightIndex = rightIndexC;
  rightMiddle = rightMiddleC;
  rightRing = rightRingC;
  rightPinky = rightPinkyO;
  alltovirtual(); // Example: alltovirtual
